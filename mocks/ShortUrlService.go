...
// Reverse provides a mock function with given fields: shortLink
func (_m *ShortUrlService) Reverse(shortLink string) (string, error) {
...
//   - shortLink string
func (_e *ShortUrlService_Expecter) Reverse(shortLink interface{}) *ShortUrlService_Reverse_Call {
	return &ShortUrlService_Reverse_Call{Call: _e.mock.On("Reverse", shortLink)}
}

func (_c *ShortUrlService_Reverse_Call) Run(run func(shortLink string)) *ShortUrlService_Reverse_Call {
...
func (_c *ShortUrlService_Reverse_Call) RunAndReturn(run func(string) (string, error)) *ShortUrlService_Reverse_Call {
	_c.Call.Return(run)
	return _c
}

// Shorten provides a mock function with given fields: someString
func (_m *ShortUrlService) Shorten(someString string) (string, error) {
	ret := _m.Called(someString)
...
//   - someString string
func (_e *ShortUrlService_Expecter) Shorten(someString interface{}) *ShortUrlService_Shorten_Call {
	return &ShortUrlService_Shorten_Call{Call: _e.mock.On("Shorten", someString)}
}

func (_c *ShortUrlService_Shorten_Call) Run(run func(someString string)) *ShortUrlService_Shorten_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *ShortUrlService_Shorten_Call) RunAndReturn(run func(string) (string, error)) *ShortUrlService_Shorten_Call {
	_c.Call.Return(run)
	return _c
}
